...
function SignUp() {
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/src/assets/react.svg" alt="React logo" width="70px" />
        ...
        >
          ...
          <FormLabel htmlFor="surname">Foydalanuvchining familiyasi</FormLabel>
          <InputGroup marginTop="-10px">
            <Input
              type="text"
              name="surname"
          ...
          <FormLabel htmlFor="username">Foydalanuvchining nomi</FormLabel>
          <InputGroup marginTop="-10px">
            <Input
              type="text"
              name="username"
          ...
          <FormLabel htmlFor="password">Foydalanuvchining paroli</FormLabel>
          <InputGroup marginTop="-10px">
            <Input
            ...
            <InputRightElement>
              {showPasswordBtn && (
                <Button
                  h="1.75rem"
                  size="sm"
                  onMouseLeave={() => setShowPasswordBtn(false)}
